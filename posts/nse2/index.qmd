...
## 4. `rlang::eval_tidy()` and Data-Masked Evaluation
...
This evaluation strategy is essential for tidyverse functions — and it's now easy to replicate thanks to `rlang::eval_tidy()`.
